...
namespace DataAccess
{
    public class clsLicenesData
    {
        ...
        public static bool GetLicenseInfoByID(ref int LicenseID, int ApplicationID, ref int DriverID, ref int LicenseClass,
     ...
     ref float PaidFees, ref bool IsActive, ref byte IssueReason, ref int CreatedByUserID)
        ...
        static public int ReNewLicenes(int ApplicationID, int DriverID,
     ...
     VALUES
        ...
        public static DataTable GetAllLicenseByDriverID(int DriverID)
        {
            ...
            string query = @"SELECT Licenses.LicenseID,  Licenses.ApplicationID, LicenseClasses.ClassName, Licenses.IssueDate,Licenses.ExpirationDate, Licenses.IsActive,Licenses.IssueReason,Licenses.CreatedByUserID   
        ...
        public static DataTable GetAllInternatinalLicenseByDriverID(int DriverID)
        {
            DataTable dataTable = new DataTable();
